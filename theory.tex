...
One important property of the electroweak Lagrangian above is that the bosons associated with the gauge fields are all massless. 
However, we now know that the W and Z bosons have masses. 
Experimental evidence for massive gauge bosons dates back to the \textcolor{red}{early?}
...
to be roughly 80 GeV and 91 GeV respectively. Therefore, the above description is incomplete. 

\section{Spontaneous Symmetry Breaking (Higgs Mechanism)}
A solution to the problems of the electroweak Lagrangian in equation \ref{eqn:LEWK} came in the form of the Higgs mechanism (\textcolor{red}{CITE}),
