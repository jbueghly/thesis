...
\newcommand{\brzg}{\ensuremath{\mathcal{B}(\PH\to\PZ\gamma)}}
\newcommand{\brgg}{\ensuremath{\mathcal{B}(\PH\to\gamma\gamma)}}
\newcommand{\wprime}{\ensuremath{\PW^{\prime}}}
...
\include{appendix_signal_fits}
\include{appendix_hmumu}
\include{appendix_impacts}
